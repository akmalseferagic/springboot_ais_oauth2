...
COPY public.khs (id_khs, nim_mhs, kode_mk, smt_khs, thajaran, nilai, jumlahnilai) FROM stdin;
851	0110115024	NF41001	Ganjil	20171	4	8
852	0110115024	SI31001	Ganjil	20171	4	8
850	0110115024	NF31001	Ganjil	20171	3	6
\.
...
COPY public.mahasiswa (nim_mhs, prodi_mhs, nama_mhs) FROM stdin;
0110115024	Sistem Informasi	Muhammad Luqni Baehaqi
\.
...
IE11001	Dasar-dasar Pemrograman	3	1
...
10	akmalseferagic@gmail.com	Mohammad Akmaluddin	 Novianto	$2a$10$sMyvS.5/L5KNMci.9sE6WOSkfSeO7KenWuxKy9JrpbTgsyvwiZgmW	0110216035
\.
...
SELECT pg_catalog.setval('public.khs_id_khs_seq', 28, true);
